        ...
        return args -> {
            if (courseRepo.count() == 0) {
                courseRepo.saveAll(List.of(
                        ...
                        Course.builder().courseId("LANGUAGE1").courseName("Tiếng Việt").otherName("Tieng Viet, Ngu van, Van hoc").build(),
                        Course.builder().courseId("LANGUAGE2").courseName("Tiếng Anh").otherName("T. Anh, English, Ngoai ngu").build(),
